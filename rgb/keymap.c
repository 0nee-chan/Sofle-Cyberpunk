 ...
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *            |Toggle| LAlt | LCTR |Lower | / ENTER /       \SPACE \  | Left |  Up  | Down | Right|
 *            |GAMING|      |      |      |/       /         \      \ |      |      |      |      |
 *            `----------------------------------'           '------''---------------------------'
 */
...
[_QWERTY] = LAYOUT( \
 ...
 KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_MUTE,     RGB_TOG, KC_N, KC_M,    KC_COMM, KC_DOT, KC_SLSH,  KC_RSFT, \
              TG(_GAMING), KC_LALT, KC_LCTRL, KC_LOWER, KC_ENT,    KC_SPC, KC_LEFT, KC_UP, KC_DOWN, KC_RGHT\
),
/* LOWER
 * ,-----------------------------------------.                    ,-----------------------------------------.
 ...
 * | Shift|  =   |  -   |  +   |   {  |   }  |-------|    |-------|   [  |   ]  |   ;  |   :  |   \  | Shift|
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *            | LGUI | LAlt | LCTR |LOWER | /Enter  /       \Space \  |Toggle| RCTR | RAlt | RGUI |
 *            |      |      |      |      |/       /         \      \ |GAMING|      |      |      |
 *            `----------------------------------'           '------''---------------------------'
 */
[_LOWER] = LAYOUT( \
...
/* GAMING
 * ,----------------------------------------.                    ,-----------------------------------------.
 * |      |      |      |      |      |      |                    | RGB+ | RGB- |RGBBR+|RGBBR-|RHUI+ |RHUI- |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * | Esc  |  Q   |   W  |   E  |  R   | T    |                    |      | PWrd |  Up  | NWrd | DLine| Bspc |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * | Tab  | A    |   S  |   D  |   F  | G    |-------.    ,-------|      | Left | Down | Rigth|  Del | Bspc |
 * |------+------+------+------+------+------|  MUTE |    |       |------+------+------+------+------+------|
 * |Shift | Undo |  Cut | Copy | Paste|      |-------|    |-------|      | LStr |      | LEnd |      | Shift|
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *           | Toogle | LAlt | LCTR |LOWER | /Space /       \Enter \  |RAISE | RCTR | RAlt | RGUI |
 *           | GAMING |      |      |      |/      /         \      \ |      |      |      |      |
 *            `----------------------------------'            '------''---------------------------'
 */
[_GAMING] = LAYOUT( \
  KC_ESC,   KC_1,   KC_2,    KC_3,    KC_4, KC_5,                          RGB_MOD, RGB_RMOD, RGB_VAI, RGB_VAD, RGB_HUI,RGB_HUD, \
  KC_TAB,  KC_Q,   KC_W,    KC_E,    KC_R, KC_T,                             KC_PGUP, KC_PRVWD, KC_UP, KC_NXTWD, KC_DLINE, KC_BSPC, \
  KC_LSFT, KC_A,   KC_S,    KC_D,    KC_F, KC_G,                           KC_PGDN,  KC_LEFT, KC_DOWN, KC_RGHT,  KC_DEL, KC_BSPC, \
  KC_LCTRL, KC_Z,   KC_X,    KC_C,    KC_V, XXXXXXX,  KC_MUTE,       _______,  XXXXXXX, KC_LSTRT, XXXXXXX, KC_LEND, XXXXXXX, _______, \
               TG(_GAMING), XXXXXXX, XXXXXXX, XXXXXXX, KC_SPC,       KC_ENT, XXXXXXX , _______, _______, BL_TOGG \
),
/* ADJUST
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * |      |      |      |      |      |      |                    |      |      |      |      |      |      |
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    switch (keycode) {
        ...
        case KC_LOWER:
            if (record->event.pressed) {
                layer_on(_LOWER);
                update_tri_layer(_LOWER, _GAMING, _ADJUST);
            } else {
                layer_off(_LOWER);
                update_tri_layer(_LOWER, _GAMING, _ADJUST);
            }
